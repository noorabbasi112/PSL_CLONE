...
<h1 class="main-heading"> HBL PSL SEASON 7 </h1>
...
$q = mysqli_query($con, "SELECT * FROM psl_2022_matches ORDER BY match_date ASC");
...
<div class="match-schedule-container">
  <table border="1" cellpadding="8" cellspacing="0" style="width:100%; border-collapse:collapse; text-align:center;">
    <thead style="background:#f1f1f1;">
      <tr>
        <th style = "color: 1px solid black;">Sr. No</th>
        <th style = "color: 1px solid black;">Match Date</th>
        <th style = "color: 1px solid black;">Teams</th>
        <th style = "color: 1px solid black;">Match Name</th>
        <th style = "color: 1px solid black;">Ground</th>
        <th style = "color: 1px solid black;">Country</th>
      </tr>
    </thead>
    <tbody>
